...
def create_booking():
    ...
    try:
        ...
        return jsonify({
            'success': False,
            'error': 'Invalid property or vehicle selected'
        }), 400
    ...
    try:
        ...
        if end_date <= start_date:
            return jsonify({
                'success': False,
                'error':
                    'Check-out/return date must be after '
    ...
    # Security deposit applies only to vehicles
    ...
    # =========================================================================
    #
    # These booking statuses block the selected dates:
    #
    # pending    -> booking created
    # confirmed  -> booking confirmed
    # active     -> active rental
    #
    # These statuses do not block dates:
    #
    # completed
    # rejected
    # cancelled
    ...
    overlapping_query = (
        Booking.query
        .filter(
            Booking.listing_type == listing_type,
    ...
    if overlapping_booking:
        ...
        if listing_type == 'property':
            ...
            item_name = veh.vehicle_name

        return jsonify({
            'success': False,
            'error': (
                f'{item_name} is already booked for '
